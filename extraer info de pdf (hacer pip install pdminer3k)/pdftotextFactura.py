...
#Compra
#pdf ="FACTURA.pdf"
#pdf = "fact de compra gm.pdf"
#venta
#pdf = "factura division laser_SB.pdf"
pdf = "factura sanchez e hijas _Gminox.pdf"
txt = "auxiliar.txt"
...
#variable = pdf2txtCompra(pdf,txt)
variable = pdf2txtVenta(pdf,txt)